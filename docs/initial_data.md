...
#### исунок 8. Справочник «Календари»
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_8.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_9.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_10.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_11.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_12.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_13.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_14.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_15.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_16.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_17.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_18.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_19.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_20.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_21.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_22.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_23.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_24.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_25.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_26.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_27.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_28.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_29.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_30.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_31.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_32.png)
#### Рисунок 33. Записи по регистру бухгалтерии «Управленческий»
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_33.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_34.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_35.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_36.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_37.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_38.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_39.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_40.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_41.png)
...
![Ответ на главный вопрос жизни, вселенной и вообще в номенклатурных группах видимо. :С](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_42.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_43.png)

Далее  следует выбрать номенклатурную группу и назначить для нее дополнительный реквизит (или несколько реквизитов), воспользовавшись кнопкой Подбор, как показано на рисунке 44. В этом примере мы назначили два реквизита (цвет и диаметр) для номенклатурной группы «Основная группа».

#### Рисунок 44. Назначение набора доп.реквизитов характеристик номенклатурной группы
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_44.png)

Теперь  можно закрыть форму  Наборы дополнительных реквизитов и сведений.

После  выполнения этих  действий, всем номенклатурным позициям, относящихся к данной номенклатурной группе, можно будет  назначить дополнительные характеристики, каждая из которых состоит  из набора дополнительных реквизитов, которые мы определили. См. рисунок 45.

##### Рисунок 45. Ввод характеристик для номенклатурной позиции
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_45.png)

В показанном на рисунке 45 примере мы определили характеристику «черный, диаметр  92см»  для номенклатурной позиции «Батут», которая относится к номенклатурной группе «Основная группа».

## Справочник «Номенклатура»
Итак, переходим непосредственно к справочнику Номенклатура. При вводе  новой номенклатурной позиции в справочник Номенклатура важно не ошибиться с указанием реквизита Тип (см. рисунок 46).
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_46.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_47.png)

На рисунке 47  приведена форма карточки номенклатуры типа  Запас. Рассмотрим  Основные параметры номенклатуры, имеющий тип  Запас: Единица измерения – единица учета  запаса  в программе. Номенклатурная группа – это понятие мы рассмотрели выше.
...
Для наглядности на вкладке Основные параметры можно разместить изображение запаса. Для этого  нужно сделать  следующие действия:
 1.  Загрузить файл изображения в информационную базу  (ссылка Присоединенные файлы располагается в левой  части  карточки номенклатуры –- см. рисунки 47 и 48).
 2.  Выбрать  этот файл непосредственно на вкладке Основные параметры  (см. рисунок 48).

#### Рисунок 48. Выбор  файла  с изображением из списка присоединенных файлов
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_48.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_50.png)

#### Рисунок 51. Ввод характеристик
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_51.png)

Отметим, что в примере, показанном на рисунке 51, характеристика номенклатуры складывается только из двух  реквизитов – цвета  и диаметра. На практике же могут  встречаться и комбинации из трех  и более реквизитов – например, цвета, размера, типа  упаковки.  Программа УНФ позволят формировать характеристики,
...
Говоря  о характеристиках, необходимо подчеркнуть, что полный список характеристик для конкретной номенклатурной позиции формируется из характеристик этой  самой  номенклатурной позиции и характеристик номенклатурной группы, к которой относится данная позиция. Характеристики номенклатурной группы вводятся в карточке номенклатурной группы аналогичным образом. См. рисунок 52.

#### Рисунок 52. Ссылка «Характеристики» в карточке номенклатурной группы
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_52.png)

Закончив с характеристиками, перейдем к параметрам управления запасами. Для номенклатуры типа  Запас характерно наличие в программе информации о максимальном и минимальном уровне. Доступ к этой информации осуществляется из карточки номенклатуры по ссылке Управление  запасами. См. – рисунки 53 и 54.

#### Рисунок 53. Ссылка «Управление запасами» в карточке запаса
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_53.png)

#### Рисунок 54. Установка минимального и максимального уровня запаса
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_54.png)
...
реквизитов на вкладке Основные параметры – аналогичны реквизитам для типа  Запас. За исключением номенклатуры типа  Работа. Для нее на вкладке Основные параметры определяется также способ  расчета стоимости работы  для заказчика (Рисунок 55).

#### Рисунок 55. Определение способа расчета стоимости работы
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_55.png)
...
Кроме  того, для номенклатуры типа  Работа с помощью ссылки Нормы времени работ (см. рисунок 55) можно ввести  данные о нормативном времени на выполнение данной работы. Нормативное время  вводится в часах. Указанная здесь  норма  времени используется программой, в частности, для подстановки значения в реквизит Время табличной части  документа Заказ-наряд.
...
Доступ к ценам  той или  иной  номенклатурной позиции возможен по ссылке Цены,  расположенной в карточке номенклатуры (см. рисунок 56). Значения цен могут  быть заданы здесь  же, либо  из формы  прайс-листа, что мы рассмотрим далее.

#### Рисунок 56. Ссылка «Цены» в карточке номенклатуры
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_56.png)

Для одной  и той же номенклатурной позиции может  быть определено несколько видов цен  (см. рисунок 57). В
графе Период вы видите дату, с которой действует та или  иная  цена.

#### Рисунок 57. История изменения цен номенклатуры
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_57.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_58.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_59.png)

#### Рисунок 60. Пример  вида  цен номенклатуры
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_60.png)
...
На рисунке 61  показан пример использования механизма Формирования цен, в котором для всех  позиций ценовой группы «Спортивные комплексы и инвентарь» устанавливаются розничные цены  на основании имеющихся в программе оптовых цен.

#### Рисунок 61. Пример  использования механизма «Формирование цен»
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_61.png)

Для формирования цен вам нужно пройти всего 4 шага (см. рисунок 3.61):
 1. Выберите из списка видов  цен тот вид цены, который вы сейчас  будете  формировать.
 2. Заполните табличную часть. Укажите, для каких номенклатурных позиций вы будете  формировать цену. Табличную часть  можно заполнить вручную, а можно воспользоваться кнопкой Заполнить. Использование кнопки дает возможность группового  заполнения табличной части. Ненужные позиции можно удалить из списка. Шаг 3. Определите, каким именно способом вы будете  формировать цену:
...
Здесь стоит  добавить, что вы можете  последовательно произвести несколько действий, например, заполнить цены по приходной накладной поставщика (По документу), затем увеличить их на процент наценки (Изменить на %) – и вот вам готова цена  продажи.
 4. Укажите дату, с которой будет  действовать сформированная вами  цена, и нажмите кнопку Установить. Использование механизма Формирование цен позволяет существенно сократить время  на ввод  данных о ценах
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_62.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_63.png)
...
Теперь, когда введены остатки заказов, необходимо вернуться к документам ввода  остатков взаиморасчетов. Возможно, какие-либо из введенных долгов относятся к конкретным заказам? Если да, то эти заказы необходимо выбрать в табличной части  документа Ввод начальных остатков. См. рисунок 64.

#### Рисунок 64. Введенные остатки долгов могут  относиться к имеющимся незакрытым заказам
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_64.png)

Теперь  прокомментируем флажок Автоформирование документов расчетов, расположенный над табличной частью документа.

Особенностью ввода  остатков взаиморасчетов является то, что программа может  потребовать обязательное указание документа, по которому возникла задолженность. Это возникает в том случае, когда по контрагенту определена необходимость учета  взаиморасчетов по документам – см. рисунок 65.

#### Рисунок 65. Учет взаиморасчетов по документам
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_65.png)
...
Во-первых, документ Ввод начальных остатков по разделу Запасы, предназначен не только для ввода остатков запасов, лежащих на складах. В табличной части  формы  – пять  основных вкладок (см. рисунок 66):
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_66.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_67.png)
...
![](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_68.png)
...
Для контроля того, все ли остатки по данным управленческого учета  правильно введены в программу, можно воспользоваться отчетом  Оборотно-сальдовая ведомость. Суммы дебетовых и кредитовых оборотов должны быть  равны. См. рисунок 69.

Рисунок 69. Контроль корректности ввода  начальных остатков управленческого учета  с помощью отчета
«Оборотно-сальдовая ведомость»
![Милое число 69](https://raw.github.com/eetk/1c-management-small-firm/master/docs/statics/1_69.png)
